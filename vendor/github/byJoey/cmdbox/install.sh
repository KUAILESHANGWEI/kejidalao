...
export_quick_connect() {
    ...
    echo ""
    echo -e "${gl_lv}bash <(curl -l -s https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/byJoey/cmdbox/install.sh) --sync \"$GITHUB_REPO\" \"$GITHUB_TOKEN\"${gl_bai}"
    echo ""
...
show_help() {
    ...
    echo "  bash <(curl -l -s https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/byJoey/cmdbox/install.sh) --sync \"username/repo\" \"your_token\""
    echo ""
    echo "使用说明:"
