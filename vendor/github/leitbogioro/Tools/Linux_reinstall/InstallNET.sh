...
function DebianModifiedPreseed() {
	if [[ "$linux_relese" == 'debian' ]] || [[ "$linux_relese" == 'kali' ]]; then
		debianConfFileDir="https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Debian"
...
if [[ "$linux_relese" == 'debian' ]] || [[ "$linux_relese" == 'kali' ]] || [[ "$linux_relese" == 'ubuntu' ]]; then
	...
	if [[ "$setAutoConfig" == "1" ]]; then
		...
		if [[ "$IsCN" == "cn" ]]; then
			...
			alpineInstallOrDdAdditionalFiles "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Alpine/alpineInit.sh" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Alpine/network/resolv.conf" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Alpine/motd.sh" "archive.ubuntu.com" "ports.ubuntu.com" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Ubuntu/ubuntuInit.sh" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Windows/windowsInit.sh" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Windows/SetupComplete.bat" "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/RedHat/RHELinit.sh" "security.ubuntu.com"
		...
		alpineNetcfgMirror="https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Alpine/network/"
		[[ "$targetRelese" == 'Ubuntu' ]] && {
			ubuntuCloudinitMirrorCn="https://gitee.com/mb9e8j2/Tools/raw/master/Linux_reinstall/Ubuntu/CloudInit/"
			ubuntuCloudinitMirror="https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/Ubuntu/CloudInit/"
		}
		[[ "$targetRelese" == 'AlmaLinux' || "$targetRelese" == 'Rocky' ]] && {
			...
			rhelCloudinitMirror="https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/leitbogioro/Tools/Linux_reinstall/RedHat/CloudInit/"
		}
		if [[ "$IPStackType" == "IPv4Stack" ]]; then
			if [[ "$Network4Config" == "isDHCP" ]]; then
				if [[ "$IsCN" == "cn" ]]; then
