...
Update_Shell() {
	echo -e "${INFO} 正在更新脚本..."
	wget -O tcpx.sh "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/ylx2016/Linux-NetSpeed/tcpx.sh" && chmod +x tcpx.sh && ./tcpx.sh
	exit 0
}

gototcp() {
	echo -e "${INFO} 正在切换到卸载内核版本..."
	wget -O tcp.sh "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/ylx2016/Linux-NetSpeed/tcp.sh" && chmod +x tcp.sh && ./tcp.sh
	exit 0
}

gotodd() {
	echo -e "${INFO} 正在切换到一键 DD 系统脚本..."
	wget -qO- "https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/bin456789/reinstall/reinstall.sh" | bash
	exit 0
}
