...
def update_server(name, hostname, port, username, password, domain, dbrootpasswd, dbuse, dbusepasswd):
    try:
        ...
        command = '''wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/docker/LNMP-docker-compose-4.yml && \
