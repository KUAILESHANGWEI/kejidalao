...
def update_server(name, hostname, port, username, password, domain, dbrootpasswd, dbuse, dbname ):
    try:
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/conf.d/' + domain + '.conf https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/nginx/discuz.com.conf && \
        ...
        command = (
            ...
            'mkdir {} && '
            'cd {} && '
            'wget https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/Website_source_code/Discuz_X3.5_SC_UTF8_20230520.zip && '
