...
def update_server(name, hostname, port, username, password, domain):
    try:
        ...
        stdin, stdout, stderr = client.exec_command('curl -L "https://github.com/KUAILESHANGWEI/kejidalao/releases/download/third-party-assets/docker-compose-$(uname -s)-$(uname -m)" -o /usr/local/bin/docker-compose && chmod +x /usr/local/bin/docker-compose')
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/nginx.conf https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/nginx/nginx6.conf && sed -i "s/yuming.com/' + domain + '/g" /home/web/nginx.conf')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('wget -O /home/web/docker-compose.yml https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/docker/LNMP-docker-compose-1.yml')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('cd /home/web && wget https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/github/magicblack/maccms_down/maccms10.zip && sudo apt-get install -y unzip && unzip maccms10.zip -d html && rm maccms10.zip && mv /home/web/html/maccms10-master/* /home/web/html/')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('cd /home/web/html/template/ && wget https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/Website_source_code/DYXS2.zip && unzip DYXS2.zip && rm /home/web/html/template/DYXS2.zip && cp /home/web/html/template/DYXS2/asset/admin/Dyxs2.php /home/web/html/application/admin/controller && cp /home/web/html/template/DYXS2/asset/admin/dycms.html /home/web/html/application/admin/view/system')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
        ...
        stdin, stdout, stderr = client.exec_command('mv /home/web/html/admin.php /home/web/html/vip.php && wget -O /home/web/html/application/extra/maccms.php https://raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/vendor/kejilion/Website_source_code/maccms.php')
        while not stdout.channel.exit_status_ready():
            if stdout.channel.recv_ready():
                print(stdout.channel.recv(1024).decode(), end="")
