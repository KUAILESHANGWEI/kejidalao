...
echo -e "${gl_lv}变更完成。 Reconnect to SSH to see the changes!${gl_bai}"
...
echo "------------------------"
echo -e "${gl_kjlan}Script official website:${gl_bai}https://github.com/KUAILESHANGWEI/kejidalao            ${gl_kjlan}GitHub address:${gl_bai}${gh_https_url}github.com/KUAILESHANGWEI/kejidalao${gl_bai}"
echo "------------------------"
echo ""
}
...
while true; do
	...
	echo "Change log"
	echo "------------------------"
	echo "All logs:${gh_proxy}raw.githubusercontent.com/KUAILESHANGWEI/kejidalao/main/kejilion_sh_log.txt"
	echo "------------------------"
